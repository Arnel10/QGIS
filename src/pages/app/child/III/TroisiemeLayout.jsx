    ...
    return (
        <div>
            <p className="paragraphe">
                Vous avez maintenant vos premières bases sous SIG, et les
                systèmes de coordonnées n'ont plus de secrets pour vous... Il
                est temps de s'attaquer à une question cruciale en SIG : comment
                trouver des données ?
            </p>
            <p className="paragraphe">
                Selon votre problématique et votre zone d'étude, les réponses
                seront bien sûr très différentes. Nous vous fournirons ici
                quelques pistes, à vous d'aller plus loin !
            </p>
