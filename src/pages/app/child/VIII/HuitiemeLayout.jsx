    ...
    return (
        <div>
            ...
            <p className="paragraphe">
                Nous allons aborder ici la notion de jointure : comment partir
                de deux couches de données, ou d'une couche et d'un tableau,
                pour au final n'obtenir qu'une seule couche avec toutes les
            ...
            <div className="flex justify-end items-center py-5">
                <NavLink
                    className="btn-lien"
                    to="/app/plan-detailler/jointures/jointure-attrib"
                >
