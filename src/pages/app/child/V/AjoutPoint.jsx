    ...
    <div>
      ...
      <div className="bg-style-g p-2">
        ...
        <p className="paragraphe">
          <ul className="ml-8 tracking-[1px] text-gray-700 my-2 mt-2">
            <li className="my-1">
              <FiberManualRecord sx={{ fontSize: 10 }} />  la carte géoréférencée <a href="https://emit-ecole-de-mit.github.io/tutoqgis_mada/donnees/TutoQGIS_05_Numerisation.zip" className="lien">Oahu_Hawaiian_Islands_1906_wgs84.tif</a> située dans le dossier <span className="font-bold">TutoQGIS_05_Numerisation/donnees</span>
            </li>
            <li className="my-1">
              <FiberManualRecord sx={{ fontSize: 10 }} /> la couche vide créée dans le chapitre précédent : <span className="font-bold">batiments_oahu.shp</span>
            </li>
          </ul>
        </p>
      </div>
      ...
      <div id="coucheedit" className="mt-8 mb-4">
        <div className="bg-style-b">
          <h5 className="sous-titre">Rendre une couche éditable
          </h5>
        </div>
        ...
        <div className="mt-4">
          <div className="my-4">
            ...
            <p className="paragraphe">
              Pour rendre une couche éditable, que ce soit pour modifier les données de la table attributaire ou la géométrie d'un élément, il faut donc passer en mode édition. Nous allons faire cette manipulation pour la couche <span className="font-bold text-green-400">batiments_oahu</span> afin de pouvoir y ajouter des points.
            </p>
            <div className="bg-style-g p-2">
              <p className="paragraphe">
                Vérifiez tout d'abord que votre couche de bâtiments soit <span className="font-bold">au-dessus</span> de la carte.
              </p>
              <p className="paragraphe">
                Pour passer en mode édition : <span className="italic text-green-400">Clic droit sur le nom de la couche → Basculer en mode édition</span>
              ...
              <p className="paragraphe">
                <table>
                  <td>
                    <img src="https://emit-ecole-de-mit.github.io/tutoqgis_mada/illustrations/5_2_edition_icone.jpg" alt="" />
                  </td>
                  <td>
              ...
              <p className="paragraphe">
                sélectionnez la couche dans la table des matières puis <span className="font-bold text-green-400">Menu Couche → Basculer en mode édition .</span>
              </p>
              <div className="bg-img">
                <img
      ...
      <div id="ajoutpt" className="mt-8 mb-4">
        <div className="bg-style-b">
          <h5 className="sous-titre"> Ajout d'un point
          </h5>
        </div>
        ...
        <div className="mt-4">
          <div className="my-4">
            <div className="bg-style-g p-2">
              ...
              <p className="paragraphe">
                <img src="https://emit-ecole-de-mit.github.io/tutoqgis_mada/illustrations/5_2_ajout_icone.jpg" alt="" /> Assurez-vous que votre couche de bâtiments soit bien sélectionnée dans la table des matières, puis cliquez sur l'icône <span className="font-bold">Ajouter une entité ponctuelle</span>.
              </p>
              <p className="paragraphe">
                Cliquez sur l'école ou la poste que vous avez choisie; une fenêtre s'ouvre vous demandant de renseigner les attributs pour ce point. Laissez <span className="font-bold">Génération automatique</span> pour le champ fid, et renseignez le type de bâtiment : <span className="font-bold">poste</span>. Cliquez sur <span className="font-bold">OK</span>.
              </p>
              ...
              <p className="paragraphe">
                <img src="https://emit-ecole-de-mit.github.io/tutoqgis_mada/illustrations/5_2_sauv_icone.jpg" alt="" />  N'oubliez pas de sauvegarder vos modifications en sélectionnant la couche puis en cliquant sur l’icône <span className="font-bold"> sauvegarder les modifications</span>.
              </p>
              <p className="paragraphe">
                Vous pouvez <a href="https://emit-ecole-de-mit.github.io/tutoqgis_mada/01_02_info_geo.html#I23a" className="lien">modifier le style</a> des points dans les propriétés de la couche, rubrique Symbologie.
              </p>
              <p className="paragraphe">
      ...
      <div id="updatepoint" className="mt-8 mb-4">
        <div className="bg-style-b">
          <h5 className="sous-titre"> Modification d'un point
          </h5>
        </div>
        ...
        <div className="mt-4">
          <div className="my-4">
            ...
            <div className="bg-style-g p-2">
              ...
              <p className="paragraphe">
                Il faut également <span className="font-bold">activer la barre d'outils de numérisation avancée </span>: clic droit sur n'importe quelle barre d'outils (sauf sur un outil désactivé) et cochez si ça n'est pas déjà le cas la case Barre d'outils de numérisation avancée. Vous pouvez également passer par le menu Vue → Barres d'outils.
              </p>
              <p className="paragraphe">
                <img src="https://emit-ecole-de-mit.github.io/tutoqgis_mada/illustrations/5_2_deplacer_icone.jpg" alt="" /> Sélectionnez votre couche de bâtiments dans la table des matières, puis cliquez sur l'icône <span className="font-bold"> Déplacer l'entité</span>.
              </p>
              <p className="paragraphe">
      ...
      <div id="quitedit" className="mt-8 mb-4">
        <div className="bg-style-b">
          <h5 className="sous-titre">Quitter le mode édition
          </h5>
        </div>
        ...
        <div className="mt-4">
          <div className="my-4">
            ...
            <p className="paragraphe">
              <ul className="ml-8 tracking-[1px] text-gray-700 my-2 mt-2">
                <li className="my-1">
                  <FiberManualRecord sx={{ fontSize: 10 }} /> éviter de faire des modifications par erreur
                </li>
                <li className="my-1">
                  <FiberManualRecord sx={{ fontSize: 10 }} /> sauvegarder les modifications effectuées
                </li>
                <li className="my-1">
                  <FiberManualRecord sx={{ fontSize: 10 }} /> certains outils SIG ne peuvent fonctionner sur une couche en cours d'édition
                </li>
              </ul>
            </p>
            <div className="bg-style-g p-2">
              <p className="paragraphe">
                <img src="https://emit-ecole-de-mit.github.io/tutoqgis_mada/illustrations/5_2_edition_icone.jpg " alt="" />  Sélectionnez votre couche dans la table des matières et cliquez sur l'icône <span className="font-bold">basculer en mode édition</span>.
              </p>
              <div className="bg-img">
                <img
              ...
              <p className="paragraphe">
                <ul className="ml-8 tracking-[1px] text-gray-700 my-2 mt-2">
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> <span className="font-bold">Fermer sans enregistrer :</span> quitte le mode édition sans sauvegarder vos modifications
                  </li>
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> <span className="font-bold"> Annuler :</span> ne quitte pas le mode édition
                  </li>
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> <span className="font-bold">Enregistrer :</span> quitte le mode édition en enregistrant vos modifications.
                  </li>
                </ul>
              </p>
              <p className="paragraphe">
            ...
            <p className="paragraphe">
              Vous pouvez bien sûr décider de filer directement au chapitre d'après sur <a href="https://emit-ecole-de-mit.github.io/tutoqgis_mada/05_04_lignes.html" className="lien">la numérisation des lignes !</a>
            </p>
          </div>
        </div>
      </div>
