    ...
    <div>
      ...
      <div id="createvide" className="mt-8 mb-4">
        <div className="bg-style-b">
          <h5 className="sous-titre">Création d'une couche vide
          </h5>
        </div>
        ...
        <div className="mt-4">
          <div className="my-4">
            ...
            <div className="bg-style-g p-2">
              ...
              <p className="paragraphe">
                <FolderOpenOutlined /> Rendez-vous dans le <span className="font-bold text-green-400"> Menu Couche → Créer une couche → Nouvelle couche GeoPackage...</span> ou bien cliquez sur l'icône correspondante (vous pouvez aussi utiliser le raccourci clavier Ctrl+Maj+N).
              </p>
              <div className="bg-img">
                <img
              ...
              <p className="paragraphe">
                <ul className="ml-8 tracking-[1px] text-gray-700 my-2 mt-2">
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> <span className="font-bold">Base de données</span> : un fichier GeoPackage étant en réalité une base de données, il s'agit ici de dire quelle base sera utilisée, existante ou non. Nous considérerons ici que un fichier GeoPackage = une couche, et nous allons donc créer une nouvelle base que nous utiliserons de la même manière qu'un fichier shapefile (sans utiliser la possibilité offerte par ce format de stocker plusieurs couches dans un seul fichier) : cliquer sur le bouton ... et spécifiez le nom et l'emplacement de la couche qui sera créée
                  </li>
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> <span className="font-bold">Nom de la table </span>  ce champ est rempli automatiquement en fonction du nom spécifié ci-dessus
                  </li>
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> <span className="font-bold">Type de géométrie : </span>  Point
                  </li>
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> <span className="font-bold">SCR :  </span>  afin que cette couche soit dans le même système que la carte, vérifier que le SCR soit bien le WGS84
                  </li>
                </ul>
              </p>
              <p className="paragraphe">
              ...
              <p className="paragraphe">
                <ul className="ml-8 tracking-[1px] text-gray-700 my-2 mt-2">
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> <span className="font-bold">Nom</span> : tapez <span className="font-bold">type</span> : un champ nommé type contiendra les valeurs école ou poste
                  </li>
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} />  <span className="font-bold">Type</span> : choisissez <span className="font-bold">Donnée texte</span> car ce champ contiendra du texte et non des nombres
                  </li>
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> <span className="font-bold">Longueur maximale</span> : pour un champ de type texte, ceci correspond au nombre maximum de caractères que pourra contenir le champ. Les mot "école" et "poste" comportent tous deux 5 caractères : une largeur de 5 suffirait ici. Pour avoir un peu de marge (supposons que l'on veuille par la suite ajouter un 3ème type de bâtiment), choisissons une largeur de <span className="font-bold">10</span>.
                  </li>
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> cliquez sur le bouton <span className="font-bold">Ajouter à la liste des champs...</span>
                  </li>
                </ul>
              </p>
              <p className="paragraphe">
                ...Et enfin sur <span className="font-bold">OK</span>.
              </p>
              <p className="paragraphe">
      ...
      <div id="checking" className="mt-8 mb-4">
        <div className="bg-style-b">
          <h5 className="sous-titre"> Vérification
          </h5>
        </div>
        ...
        <div className="mt-4">
          <div className="my-4">
            <div className="bg-style-g p-2">
              <p className="paragraphe">
                Allez dans les propriétés de la couche, rubrique <span className="font-bold">Information</span> :
              </p>
              <div className="bg-img">
                <img
              ...
              <p className="paragraphe">
                Vous pouvez vérifier ici l'emplacement de votre couche (<span className="font-bold">chemin</span> ), son <span className="font-bold">SCR le nombre d'entités</span>,  qu'elle contient (à ce stade, 0).
              </p>
              <p className="paragraphe">
              ...
              <p className="paragraphe">
                Par contre, elle contient 2 champs, <span className="font-bold">fid et type</span>, alors qu'on se serait attendu à ne voir que le champ type.
              </p>
            </div>
            <p className="paragraphe">
              <span className="font-bold">A quoi correspond ce champ fid ? </span> Le GeoPackage étant une base de données, une colonne d'identifiant unique ( <a href="https://fr.wikipedia.org/wiki/Cl%C3%A9_primaire" className="lien">clé primaire</a> ) est créée automatiquement lors de la création de la couche, afin d'identifier de manière unique chaque entité.
            </p>
            <p className="paragraphe">
