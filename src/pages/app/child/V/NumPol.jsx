    ...
    <div>
      ...
      <div id="createcoupoly" className="mt-8 mb-4">
        <div className="bg-style-b">
          <h5 className="sous-titre"> Création d'une couche de polygones
          </h5>
        </div>
        ...
        <div className="mt-4">
          <div className="my-4">
            <div className="bg-style-g p-2">
              <p className="paragraphe">
                Créez une couche de polygones en vous reportant si besoin à la <a href="#" className="lien">partie V.1</a> , avec les paramètres suivants :
              </p>
              <p className="paragraphe">
                <ul className="ml-8 tracking-[1px] text-gray-700 my-2 mt-2">
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> nom : <span className="font-bold text-green-400">zones_oahu</span>.
                  </li>
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> type : <span className="font-bold">polygone</span>
                  </li>
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> deux champs de type texte, de longueur 80, nommés <span className="font-bold">type1 et type2</span> (ils contiendront les types de zone, tels qu'indiqués dans la légende)
                  </li>
                </ul>
              </p>
              <p className="paragraphe">
                Vérifiez que cette couche soit bien chargée dans votre projet, ainsi que la carte <a href="https://emit-ecole-de-mit.github.io/tutoqgis_mada/donnees/TutoQGIS_05_Numerisation.zip" className="lien">Oahu_Hawaiian_Islands_1906_wgs84.tif.</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <div id="vision" className="mt-8 mb-4">
        <div className="bg-style-b">
          <h5 className="sous-titre"> Ajout d'un polygone
          </h5>
        </div>
        ...
        <div className="mt-4">
          <div className="my-4">
            ...
            <div className="bg-style-g p-2">
              ...
              <p className="paragraphe">
                <img src="https://emit-ecole-de-mit.github.io/tutoqgis_mada/illustrations/5_5_ajout_icone.jpg" alt="" /> Cliquez sur l'icône Ajouter une entité polygonale qui a pris la forme d'un polygone.
              </p>
              <p className="paragraphe">
              ...
              <p className="paragraphe">
                Vous pouvez maintenant remplir les données attributaires pour ce polygone, par exemple en donnant la valeur <span className="font-bold"> Forest Reserves</span> en type1, et la valeur <span className="font-bold">None</span> en type2.
              </p>
            </div>
          </div>
        </div>
      ...
      <div id="cutpoly" className="mt-8 mb-4">
        <div className="bg-style-b">
          <h5 className="sous-titre"> Découpage d'un polygone
          </h5>
        </div>
        ...
        <div className="mt-4">
          <div className="my-4">
            ...
            <div className="bg-style-g p-2">
              <p className="paragraphe">
                Vérifiez que la barre d'outils <span className="font-bold">Numérisation avancée</span> soit activée : Numérisation avancée doit être cochée dans le <span className="italic text-green-400">Menu Vue → Barres d'outils</span> .
                <div className="bg-img">
                  <img
              ...
              <p className="paragraphe">
                <img src="https://emit-ecole-de-mit.github.io/tutoqgis_mada/illustrations/5_5_decoupe_icone.jpg" alt="" /> Dans la barre d'outils Numérisation avancée, cliquez sur l'icône Séparer les entités.
              </p>
              <p className="paragraphe italic">
                Attention à ne pas confondre cet outil avec celui pour <span className="font-bold">Séparer les parties</span> juste à sa droite !
              </p>
              <p className="paragraphe">
      ...
      <div id="frontier" className="mt-8 mb-4">
        <div className="bg-style-b">
          <h5 className="sous-titre"> Frontière commune entre 2 polygones : comment est-elle gérée ?
          </h5>
        </div>
        ...
        <div className="mt-4">
          <div className="my-4">
            <div className="bg-style-g p-2">
              <p className="paragraphe">
                <img src="https://emit-ecole-de-mit.github.io/tutoqgis_mada/illustrations/5_4_noeud_icone.jpg" alt="" />  A l'aide de l'outil de nœud, déplacez un sommet de la petite langue de terre d'Aiea.
              </p>
              <div className="bg-img">
                <img
              ...
              <p className="paragraphe">
                <img src="https://emit-ecole-de-mit.github.io/tutoqgis_mada/illustrations/1_1_selection_icone.jpg" alt="" /> A l'aide de l'outil de sélection, sélectionnez successivement le polygone d'Aiea, et celui qui l'entoure.
              </p>
              <p className="paragraphe">
                Que constatez-vous ? <br />
                <i>Les deux polygones ne sont plus jointifs. Le déplacement d'un sommet d'un des polygones n'a pas eu d'effet sur le sommet correspondant du deuxième polygone.</i>
              </p>
              <p className="paragraphe">
                Rendez-vous maintenant dans le <span className="font-bold">menu Projet → Options d'accrochage et activez l'édition topologique</span> en enclenchant le bouton correspondant si ça n'est pas déjà fait.
              </p>
              <div className="bg-img">
                <img
              ...
              <p className="paragraphe">
                Que constatez-vous ? <br />
                <i> Les deux polygones sont toujours jointifs. Le déplacement d'un sommet d'un des polygones a provoqué le déplacement du sommet correspondant du deuxième polygone.
                </i>
              </p>
            </div>
          </div>
      ...
      <div id="accro" className="mt-8 mb-4">
        <div className="bg-style-b">
          <h5 className="sous-titre"> Ajout d'un élément en s'appuyant sur un autre : l'accrochage
          </h5>
        </div>
        ...
        <div className="mt-4">
          <div className="my-4">
            ...
            <div className="bg-style-g p-2">
              <p className="paragraphe">
                Rendez-vous dans le <span className="font-bold">Menu Projet → Options d'accrochage</span> (cliquez sur l'image pour voir la fenêtre en plus grand) :
              </p>
              <div className="bg-img">
                <img
              ...
              <p className="paragraphe">
                <img src="https://emit-ecole-de-mit.github.io/tutoqgis_mada/illustrations/5_5_accrochage_icone.jpg" alt="" />  Cliquez sur le bouton <span className="font-bold">Activer l'accrochage</span> tout en haut à gauche de la fenêtre.
              </p>
              <p className="paragraphe">
                Choisissez le mode <span className="font-bold">Configuration avancée</span> dans la liste déroulante à droite. La liste des couches présentes dans votre projet QGIS s'affiche.
              </p>
              <p className="paragraphe">
              ...
              <p className="paragraphe">
                Par exemple, pour être automatiquement aimanté à votre couche de polygone dès que votre curseur approche à moins de 10 pixels d'un sommet de cette couche, cochez la case de <span className="font-bold">zones_oahu</span>, choisissez le mode <span className="font-bold">sommet</span> et fixe <span className="font-bold">10 pixels</span>.
              </p>
              <p className="paragraphe">
                Fermez la fenêtre des paramètres d'accrochage (ou déplacez-là là où elle ne vous gênera pas).
              </p>
              <p className="paragraphe">
                Cliquez sur l'icône <span className="font-bold">Ajouter une entité</span>, et approchez-vous d'un sommet d'un polygone déjà créé : votre curseur est aimanté par ce sommet, qui apparaît alors en rose.
              </p>
              <div className="bg-img">
                <img
      ...
      <div id="evite" className="mt-8 mb-4">
        <div className="bg-style-b">
          <h5 className="sous-titre"> Éviter les intersections entre polygones jointifs
          </h5>
        </div>
        ...
        <div className="mt-4">
          <div className="my-4">
            ...
            <div className="bg-style-g p-2">
              <p className="paragraphe">
                Pour éviter cela, rendez-vous à nouveau dans le menu Projet → Options d'accrochage et cochez la case <span className="font-bold">Éviter le chevauchement</span> pour la couche zones_oahu.
              </p>
              <div className="bg-img">
                <img
