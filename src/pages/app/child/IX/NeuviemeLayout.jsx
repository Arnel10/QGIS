    ...
    return (
        <div>
            <p className="paragraphe">
                Dans cette partie, nous allons aborder un domaine
                particulièrement utile des SIG : comment croiser spatialement
                des données, ou créer des données à partir d'autres données.
            </p>
            <p className="paragraphe">
