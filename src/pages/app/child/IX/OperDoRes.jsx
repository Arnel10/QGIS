  ...
  return (
    <div>
      ...
      <p className="paragraphe">
        Vous verrez ici quelques manipulations sur un raster d'altitude, appliquées au <a href="https://emit-ecole-de-mit.github.io/tutoqgis_mada/03_01_donnees_internet.html#III12b" className="lien">modèle d'élévation numérique (MNE)</a> de la Jamaïque.
      </p>
        ...
        <div className="mt-4">
          <div className="my-4">
            ...
            <div className="bg-style-g p-2">
              <p className="paragraphe">
                Ouvrez un nouveau projet QGIS. <a href="https://emit-ecole-de-mit.github.io/tutoqgis_mada/01_02_info_geo.html#I24" className="lien">Ajoutez la couche raster</a> <a href="https://emit-ecole-de-mit.github.io/tutoqgis_mada/donnees/TutoQGIS_09_AnalyseSpat.zip" className="lien">srtm_21_09.tif</a> située dans <span className="font-bold">TutoQGIS_09_AnalyseSpat/donnees</span>.
              </p>
              <p className="paragraphe">
              ...
              <p className="paragraphe">
                Rendez-vous dans la <span className=" text-green-400"> boîte à outils → GDAL → Extraction raster → Découper un raster selon une emprise :</span>
                <div className="bg-img">
                  <img
              ...
              <p className="paragraphe">
                <ul className="my-4 ml-8">
                  <li className="my-4">
                    <FiberManualRecord sx={{ fontSize: 10 }} />{" "}  Couche source : sélectionnez <span className="font-bold text-green-400">srtm_21_09</span>
                  </li>
                  <li className="my-4">
                    <FiberManualRecord sx={{ fontSize: 10 }} />{" "}  Etendue de découpage : cliquez sur le bouton ... tout à droite, choisissez <span className="font-bold"> Dessiner sur le canevas</span>. Il faut ensuite dessiner l'emprise à garder, toujours dans l'outil de découpage. Dessinez un rectangle approximatif autour de l'île de la Jamaïque :
                  </li>
                  ...
                  <li className="my-4">
                    <FiberManualRecord sx={{ fontSize: 10 }} />{" "} Découpé (étendue) : cliquez sur le bouton à droite ... et choisissez où la nouvelle couche sera créée, et son nom : <span className="font-bold text-green-400">srtm_jamaique</span>
                  </li>
                  <li className="my-4">
                    <FiberManualRecord sx={{ fontSize: 10 }} />{" "}  Cliquez ensuite sur Exécuter.
                  </li>
                </ul>
              </p>
              <p className="paragraphe">
            ...
            <p className="paragraphe">
              Notez qu'il est également possible de découper un raster suivant l'emprise d'une couche de polygones, en utilisant l'option <span className="font-bold">Utiliser l'emprise de la couche</span>. Vous pouvez aussi directement rentrer à la main les coordonnées de l'emprise à conserver.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="my-4">
            ...
            <div className="bg-style-g p-2">
              <p className="paragraphe font-bold">
                Propriétés de la couche <span className="text-green-400">srtm_jamaique</span> → rubrique Histogramme : cliquez sur le bouton Calculer l'histogramme.
              </p>
              <div className="bg-img">
                <img
            ...
            <p className="paragraphe">
              Une information utile à savoir est <span className="font-bold">la valeur des pixels</span> « sans données ». En effet, vous ne voyez dans QGIS que les pixels de la Jamaïque et non ceux de l'océan les environnant, bien que nous ayons précédemment découpé cette couche suivant un rectangle.
            </p>
            <p className="paragraphe">
              En fait, <span className="font-bold">un raster étant un tableau, son emprise sera toujours rectangulaire et tous les pixels auront toujours une valeur</span> . Cependant, par commodité, on donne une valeur aberrante aux pixels « sans données ». D'où ce titre énigmatique !
            </p>
            <div className="bg-style-g p-2">
              <p className="paragraphe">
                Pour savoir quelle est cette valeur : <span className="font-bold"> propriétés de la couche → rubrique Transparence :</span>
              </p>
              <div className="bg-img">
                <img
              ...
              <p className="paragraphe">
                Regardez la valeur à droite de <span className="font-bold">Aucune valeur de données</span> : pour cette couche, cette valeur est de <span className="font-bold">-32768</span> .
              </p>
            </div>
            <p className="paragraphe">
            ...
            <div className="bg-style-g p-2">
              <p className="paragraphe">
                Pour tester cela, décochez la case devant <span className="font-bold">Aucune valeur de données</span> et fermez la fenêtre des propriétés. Vous pouvez voir toute l'emprise de la couche, y compris les pixels sans données.
              </p>
              <p className="paragraphe">
                <img src="https://emit-ecole-de-mit.github.io/tutoqgis_mada/illustrations/1_2_informations_icone.jpg" alt="" />  Vous pouvez utiliser l'outil Identifier des entités pour cliquer sur un pixel « sans données » sur le bord du raster et voir que sa valeur correspond bien à -32768.
              </p>
              <div className="bg-img">
                <img
              ...
              <p className="paragraphe">
                Retournez dans les propriétés de la couche et recochez la case <span className="font-bold"> Aucune valeur de données.</span>
              </p>
              <p className="paragraphe">
            ...
            <p className="paragraphe">
              Rendez-vous <a href="http://desktop.arcgis.com/fr/arcmap/10.3/manage-data/raster-and-images/bit-depth-capacity-for-raster-dataset-cells.htm" className="lien">ici</a> pour en savoir plus sur les différents types de raster et les données qu'ils peuvent contenir. En règle général, on choisit le type codé sur le moins de bits possibles en restant compatible avec les données, pour obtenir des rasters moins lourds.
            </p>
            ...
            <div className="bg-style-g p-2">
              <p className="paragraphe">
                Rendez-vous dans les propriétés de la couche, rubrique <span className="font-bold">Symbologie</span>.
              </p>
              <p className="paragraphe">
                A la place de <span className="font-bold">Bande grise unique</span> , sélectionnez <span className="font-bold">Pseudo-couleur à bande unique</span>  et appliquez les changements (sans forcément fermer la fenêtre des propriétés).
              </p>
              <div className="bg-img">
                <img
              ...
              <p className="paragraphe">
                Il est possible de modifier les classes, soit de manière automatique en choisissant le mode <span className="font-bold">intervalle égal</span> ou <span className="font-bold">quantile</span> et le nombre de classes, sous le tableau des valeurs, soit à la main en double-cliquant sur une valeur dans le tableau.
              </p>
              <p className="paragraphe italic font-bold">
                Pour en savoir plus sur les méthodes de discrétisation : voir notamment <a href="https://blog.m0le.net/2014/09/08/cartographie-numerique-precis-de-discretisation-pour-les-nuls/" className="lien">ici</a> .
              </p>
              <p className="paragraphe">
      ...
      <div id="manip" className="mt-8 mb-4">
        ...
        <div className="mt-4">
          <div className="my-4">
            ...
            <div className="bg-style-g p-2">
              <p className="paragraphe">
                Rendez-vous dans la <span className="font-bold italic">boîte à outils → Analyse raster → Raster calculator</span> :
              </p>
              <div className="bg-img">
                <img
              ...
              <p className="paragraphe">
                <ul className="ml-8 tracking-[1px] text-gray-700 my-2 mt-2">
                  <li className="my-1">
                    <FiberManualRecord
                      sx={{ fontSize: 10 }}
                    />{" "}  Dans la partie <span className="font-bold">Couches</span> en haut à gauche, double-cliquez sur <span className="font-bold text-green-400">srtm_jamaique</span> pour faire apparaître le nom de la couche dans la partie <span className="font-bold">Expression</span> en-dessous
                  </li>
                  <li className="my-1">
                    <FiberManualRecord
                      sx={{ fontSize: 10 }}
                    />{" "}  Complétez l'expression en rajoutant à la main <span className="font-bold">{"<"} 100</span> : l'expression complète est donc <span className="font-bold"> "srtm_jamaique@1" {"<"} 100</span>
                  </li>
                  <li className="my-1">
                    <FiberManualRecord
                      sx={{ fontSize: 10 }}
                    />{" "}  Dans la partie <span className="font-bold">Reference Layer(s)</span> , cliquez sur le bouton ... à doite et sélectionnez la couche <span className="font-bold text-green-400">srtm_jamaique</span>, pour que le raster créé ait la même emprise, résolution et CRS
                  </li>
                </ul>
              </p>
              <p className="paragraphe">
            ...
            <div className="bg-style-g p-2">
              ...
              <p className="paragraphe">
                Il est facile de changer le mode de représentation, par exemple dans  <span className="font-bold">les propriétés → Symbologie → Dégradé de couleur : choisir Blanc vers noir au lieu de Noir vers blanc.</span>
              </p>
              <div className="bg-img">
                <img
      ...
      <div id="exalt" className="mt-8 mb-4">
        ...
        <div className="mt-4">
          <div className="my-4">
            ...
            <p className="paragraphe italic text-center">
              Un extrait de carte avec des courbes de niveau (Source : <a href="https://emit-ecole-de-mit.github.io/commons.wikimedia.org/wiki/File_Cntr-map-1.html" className="lien">Wikimedia</a> )
            </p>
            <div className="bg-style-g p-2">
              <p className="paragraphe">
                Rendez-vous dans <a href="#" className="lien">la boîte à outils → GDAL → Extraction raster → Courbe de niveau </a>(dans les versions pécédentes de QGIS, cet outil peut se nommer contour) :
              </p>
              <div className="bg-img">
                <img
              ...
              <p className="paragraphe">
                <ul className="ml-8 tracking-[1px] text-gray-700 my-2 mt-2">
                  <li className="my-1">
                    <FiberManualRecord
                      sx={{ fontSize: 10 }}
                    />{" "} Couche source : sélectionnez <span className="font-bold text-green-400">srtm_jamaique</span>
                  </li>
                  <li className="my-1">
                    <FiberManualRecord
                      sx={{ fontSize: 10 }}
                    />{" "} Intervalle entre les courbes de niveaux : tapez <span className="font-bold">100</span> pour un intervalle de 100 mètres
                  </li>
                  <li className="my-1">
                    <FiberManualRecord
                      sx={{ fontSize: 10 }}
                    />{" "} <span className="font-bold">Nom de l'attribut</span> : il s'agit du nom du champ qui contiendra l'altitude de la courbe. Vous pouvez laisser la valeur par défaut <span className="font-bold">ELEV</span>, ou bien taper le nom de votre choix
                  </li>
                </ul>
              </p>
              <p className="paragraphe">
            ...
            <p className="paragraphe">
              La première étape est donc de <span className="font-bold"> projeter notre raster, pour obtenir des unités identiques verticalement et horizontalement.</span>
            </p>
            <p className="paragraphe">
              Quelle projection utiliser pour notre raster ?
            </p>
            <p className="paragraphe">
              En règle générale, il y a deux possibilités quand on cherche une projection pour un pays : utiliser une projection nationale, ou bien une <a href="https://emit-ecole-de-mit.github.io/tutoqgis_mada/02_02_coord.html#II22d" className="lien"> projection UTM.</a>
            </p>
            <p className="paragraphe">
            ...
            <div className="bg-style-g p-2">
              <p className="paragraphe">
                <img src="https://emit-ecole-de-mit.github.io/tutoqgis_mada/illustrations/2_3_scr_projet_icone.jpg" alt="" />
                Rendez-vous dans les propriétés du projet, rubrique SCR, par exemple en cliquant sur l'icône de sphère tout en bas à droite de la fenêtre de QGIS :
              </p>
              <div className="bg-img">
                <img
              ...
              <p className="paragraphe">
                Tapez <span className="font-bold">jamaica</span> dans la rubrique <span className="font-bold">Filtre</span> : plusieurs réponses sont proposées, dont 3 SCR projetés. Une rapide recherche internet semble indiquer que le SCR <span className="font-bold">JAD2001</span> est le plus récent (source : <a href="http://www.jamaicancaves.org/jad2001.htm" className="lien">http://www.jamaicancaves.org/jad2001.htm </a> ). C'est donc ce SCR que nous utiliserons.
              </p>
              <p className="paragraphe">
                Sélectionnez <span className="font-bold">JAD2001 (code EPSG:3448) et cliquez sur OK</span> .
              </p>
            </div>
            <p className="paragraphe">
            ...
            <div className="bg-style-g p-2">
              <p className="paragraphe">
                Une étape préliminaire avant de projeter le raster : ouvrez les propriétés du raster, rubrique <span className="font-bold">Information</span>, sous-rubrique <span className="font-bold">Bandes</span>, recherchez <span className="font-bold">Aucune valeur de données</span>. Vous devriez avoir -32768, notez cette valeur. C'est celle utilisée pour les pixels « sans valeur » (qui ont donc en réalité la valeur -32768), en-dehors de l'île.
              </p>
              <p className="paragraphe">
                Ensuite, pour changer le SCR du raster : <span className="text-green-400"> Boîte à outils → GDAL → Projections raster → Projection (warp) :</span>
              </p>
              <div className="bg-img">
                <img
              ...
              <p className="paragraphe">
                <ul className="ml-8 tracking-[1px] text-gray-700 my-2 mt-2">
                  <li className="my-1">
                    <FiberManualRecord
                      sx={{ fontSize: 10 }}
                    />{" "} Couche source : sélectionnez <span className="text-green-400">srtm_jamaique</span> dans la liste
                  </li>
                  <li className="my-1">
                    <FiberManualRecord
                      sx={{ fontSize: 10 }}
                    />{" "} SCR cible : cliquez sur le bouton à droite pour rechercher le SCR <span className="font-bold">JAD2001 code EPSG:3448</span>
                  </li>
                  <li className="my-1">
                    <FiberManualRecord
                      sx={{ fontSize: 10 }}
                    />{" "}  Valeur Nodata : tapez la <a href="https://emit-ecole-de-mit.github.io/tutoqgis_mada/09_02_raster.html#IX22b" className="lien">valeur des pixels sans données</a> : <span className="font-bold">-32768</span>
                  </li>
                  <li className="my-1">
                    <FiberManualRecord
                      sx={{ fontSize: 10 }}
                    />{" "} Laissez tous les autres paramètres par défaut, cliquez sur <span className="font-bold">Exécuter</span>.
                  </li>
                </ul>
              </p>
              <p className="paragraphe">
              ...
              <p className="paragraphe italic">
                Supprimez les autres couches, pour ne garder dans le projet que la couche <span className="font-bold text-green-400">srtm_jamaique_JAD2001</span>.
              </p>
            </div>
            ...
            <div className="bg-style-g p-2">
              <p className="paragraphe">
                Rendez-vous dans la <span className="text-green-400">boîte à outils → GDAL → Analyse raster → Pente :</span>
              </p>
              <div className="bg-img">
                <img
              ...
              <p className="paragraphe">
                <ul className="ml-8 tracking-[1px] text-gray-700 my-2 mt-2">
                  <li className="my-1">
                    <FiberManualRecord
                      sx={{ fontSize: 10 }}
                    />{" "} Couche source : sélectionnez <span className="font-bold text-green-400">srtm_jamaique_JAD2001</span>
                  </li>
                  <li className="my-1">
                    <FiberManualRecord
                      sx={{ fontSize: 10 }}
                    />{" "} Laissez les autres paramètres par défaut (pour plus d'infos sur les méthodes de Zevenberger & Thorne et Horn : <a href=" http://www.macaulay.ac.uk/LADSS/documents/DEMs-for-spatial-modelling.pdf" className="lien"> http://www.macaulay.ac.uk/LADSS/documents/DEMs-for-spatial-modelling.pdf</a>, pp. 12 et 13).
                  </li>
                </ul>
              </p>
              <p className="paragraphe">
                Cliquez sur <span className="font-bold">Exécuter</span>, patientez... la couche s'affiche :
              </p>
              <div className="bg-img">
                <img
              ...
              <p className="paragraphe">
                <img src="https://emit-ecole-de-mit.github.io/tutoqgis_mada/illustrations/8_2_id_icone.jpg " alt="" />  En cliquant sur un pixel avec l'outil Identifier les entités, vous pouvez connaître la valeur de la pente pour ce pixel :
              </p>
              <div className="bg-img">
                <img
