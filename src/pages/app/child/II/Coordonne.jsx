            ...
            <ul className="ml-8">
              ...
              <li>
                <a
                  ...
                  className="hover:text-blue-600 hover:underline"
                >
                  Quelques exemples de systèmes de coordonnées                </a>
              </li>
            </ul>
          </li>
          <li className="my-2">
          ...
          <div class="overflow-x-auto relative shadow-md sm:rounded-lg mx-5">
            <table class="w-full text-sm text-left text-gray-500">
              <thead class="text-xs text-gray-700 uppercase bg-green-500">
                <tr>
                  <th scope="col" class="py-3 px-6">Système de coordonnées</th>
                  <th scope="col" class="py-3 px-6">Code</th>
                  <th scope="col" class="py-3 px-6">Latitude (en degrés)</th>
                  <th scope="col" class="py-3 px-6">Longitude (en degrés)</th>
                </tr>
              </thead>
              <tbody>
                <tr class="bg-green-200 border-b">
                  <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap">WGS84</th>
                  <td class="py-4 px-6">EPSG:4326</td>
                  <td class="py-4 px-6">48,85700</td>
                  <td class="py-4 px-6">2,35100</td>
                </tr>
                <tr class="bg-green-100 border-b">
                  <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap">ED50</th>
                  <td class="py-4 px-6">EPSG:4230</td>
                  <td class="py-4 px-6">48,857615</td>
                  <td class="py-4 px-6">2,532286</td>
                </tr>
                <tr class="bg-green-200 border-b">
                  <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap">RGF93</th>
                  <td class="py-4 px-6">EPSG:4171</td>
                  <td class="py-4 px-6">48,85700</td>
                  <td class="py-4 px-6">2,35100</td>
                </tr>
                <tr class="bg-green-100">
                  <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap">NTF</th>
          ...
          <div className="my-4">
            <p className="tracking-[1px] text-gray-700 my-2">
              ...
              <ul className="ml-8 tracking-[1px] text-gray-700 my-2">
                ...
                <li className="my-1">
                  <FiberManualRecord sx={{ fontSize: 10 }} /> de rendre plus facile une évaluation des distances
                </li>
              </ul>
            </p>
          </div>
          ...
          <div className="my-4">
            ...
            <p className="tracking-[1px] text-gray-700 my-2">
              ...
              <ul className="ml-8 tracking-[1px] text-gray-700 my-2 mt-2">
                ...
                <li className="my-1">
                  <FiberManualRecord sx={{ fontSize: 10 }} /> les projections <span className="font-bold">conformes</span> qui conservent les angles.
                </li>
                <li className="my-1">
                  <FiberManualRecord sx={{ fontSize: 10 }} /> les projections <span className="font-bold">aphylactiques</span>, ni conformes ni équivalentes. Elles peuvent être équidistantes, c'est-à-dire conserver les distances sur les méridiens.
                </li>
              </ul>
            </p>
          </div>
            ...
            <div className="flex flex-col justify-center items-center my-8 bg-slate-50 py-2 shadow-md shadow-green-200">
              <div class="overflow-x-auto relative shadow-md sm:rounded-lg mx-5">
                <table class="w-full text-sm text-left text-gray-500">
                  <thead class="text-xs text-gray-700 uppercase bg-green-500">
                    <tr>
                      <th scope="col" class="py-3 px-6">Système et projection	</th>
                      <th scope="col" class="py-3 px-6">Code</th>
                      <th scope="col" class="py-3 px-6">X (en mètres)	</th>
                      <th scope="col" class="py-3 px-6">Y (en mètres)</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr class="bg-green-200 border-b">
                      <td class="py-4 px-6">Mercator</td>
                      <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap">EPSG:54004	</th>
                      <td class="py-4 px-6">261712</td>
                      <td class="py-4 px-6">6218386</td>
                    </tr>
                    <tr class="bg-green-100 border-b">
                      <td class="py-4 px-6">Peters</td>
                      <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap">SR-ORG:22	</th>
                      <td class="py-4 px-6">185369</td>
                      <td class="py-4 px-6">6753027</td>
                    </tr>
                    <tr class="bg-green-200 border-b">
                      <td class="py-4 px-6">RGF93 Lambert93	</td>
                      <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap">EPSG:2154	</th>
                      <td class="py-4 px-6">652381</td>
                      <td class="py-4 px-6">6862047</td>
                    </tr>
                    <tr class="bg-green-100">
                      <td class="py-4 px-6">Azimutale équidistante pôle sud	</td>
                      <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap">EPSG:102019	</th>
          ...
          <div className="mt-4">
            <div className="my-4">
              <p className="tracking-[1px] text-gray-700 my-2">
                ...
                <ul className="ml-8 tracking-[1px] text-gray-700 my-2 mt-2">
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> sous forme de coordonnées géographiques en degrés : latitude, longitude, hauteur ellipsoïdale. Ces coordonnées sont calculées <span className="font-bold">dans un système géodésique de référence, sans utilisation de projection</span>
                  </li>
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> sous forme de coordonnées en projection en mètres (représentation plane), calculées <span className="font-bold"> dans un système géodésique de référence et avec une projection cartographique</span>
                  </li>
                </ul>
              </p>
            </div>
            ...
            <div className="my-4">
              <p className="tracking-[1px] text-gray-700 my-2">
                <span className="font-bold">Pour simplifier, dans le reste de ce tutoriel, le système de coordonnées et sa projection associée s'il y en a une seront nommés SCR (Système de Coordonnées de Référence) suivant la terminologie utilisée par QGIS.
                </span>
              </p>
            </div>
          </div>
          ...
          <div className="mt-4">
            <div className="my-4">
              <p className="tracking-[1px] text-gray-700 my-2">
                ...
                <ul className="ml-8 tracking-[1px] text-gray-700 my-2 mt-2">
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> Comprendre le principe des projections :  <a rel="noopener noreferrer" class="text-blue-500 hover:text-blue-600 hover:underline" href="https://www.onf.ca/film/carte_impossible/" target="_blank"> la carte impossible </a>
                  </li>
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> « Déplier la Terre » pour mieux comprendre certaines projections :  <a rel="noopener noreferrer" class="text-blue-500 hover:text-blue-600 hover:underline" href="https://philogb.github.io/page/myriahedral/" target="_blank"> Myriahedral Projections </a>
                  </li>
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> Visualiser les déformations liées à des projections : <a rel="noopener noreferrer" class="text-blue-500 hover:text-blue-600 hover:underline" href="https://mathigon.org/course/circles/spheres-cones-cylinders#sphere-maps" target="_blank">  Surface Area of a Sphere </a>
                  </li>
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> Liste des systèmes de coordonnées avec leurs codes EPSG ou autre :
                    <a rel="noopener noreferrer" class="text-blue-500 hover:text-blue-600 hover:underline" href="http://spatialreference.org/I" target="_blank">http://spatialreference.org/ </a>
                  </li>
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> Comparaison de projections : <a rel="noopener noreferrer" class="text-blue-500 hover:text-blue-600 hover:underline" href="https://blocks.roadtolarissa.com/syntagmatic/ba569633d51ebec6ec6e" target="_blank"> https://blocks.roadtolarissa.com/syntagmatic/ba569633d51ebec6ec6e</a>  et <a rel="noopener noreferrer" class="text-blue-500 hover:text-blue-600 hover:underline" href=" https://www.map-projections.net/imglist.php" target="_blank">  https://www.map-projections.net/imglist.php</a>
                  </li>
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> Aide au choix d'une projection :
                    <a rel="noopener noreferrer" class="text-blue-500 hover:text-blue-600 hover:underline" href="http://projectionwizard.org/" target="_blank"> http://projectionwizard.org/ </a>
                  </li>
                  <li className="my-1">
                    <FiberManualRecord sx={{ fontSize: 10 }} /> Sur la précision des coordonnées : jusqu'où faut-il aller dans le nombre de décimales ?
                    <a rel="noopener noreferrer" class="text-blue-500 hover:text-blue-600 hover:underline" href="https://xkcd.com/2170/" target="_blank">  https://xkcd.com/2170/ </a>
                  </li>
