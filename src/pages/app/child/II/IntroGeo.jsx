  ...
  return (<div>
    ...
    <div id="definition" className="mt-8 mb-4">
      ...
      <div className="mt-4">
        ...
        <div className="my-4">
          <p className="paragraphe">
            La géodésie est une science ancienne ; on attribue au grec <a rel="noopener noreferrer" class="text-blue-500 lien" href="https://fr.wikipedia.org/wiki/%C3%89ratosth%C3%A8ne" target="_blank">Eratosthène</a>   (276 à 194 av. JC) la première mesure de la circonférence de la Terre, qu'il évalua à environ 39 375 km. Cette mesure s'est révélée proche de la réalité puisque les estimations actuelles sont d'environ 40 075 km.
          </p>
        </div>
      </div>
    </div>
